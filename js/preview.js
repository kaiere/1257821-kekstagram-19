...
(function () {
  ...
  // ПРОБЛЕМА модуль 7: при клике по маленьким фото после сортировки браузер отображает большие по прежним id
  // Т.е. id сам не меняется после фильтрафии, это я понимаю. Можно это как-то исправить?
  // Или все же стоит поменять код?
